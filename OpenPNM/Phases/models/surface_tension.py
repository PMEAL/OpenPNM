...
def eotvos(phase, k, pore_molar_density='pore.molar_density', **kwargs):
    r"""
    Documentation for this method is being updated, we are sorry for the
    inconvenience.
    """
    Tc = phase['pore.Tc']
    T = phase['pore.temperature']
...
def guggenheim_katayama(phase, K2, n, **kwargs):
    r"""
    Documentation for this method is being updated, we are sorry for the
    inconvenience.
    """
...
def brock_bird_scaling(phase, sigma_o, To, **params):
    r"""
