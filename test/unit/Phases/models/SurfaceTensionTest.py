...
class SurfaceTensionTest:
    ...
    def test_brock_bird_scaling(self):
        self.phase.models.add(propname='pore.surface_tension',
                              model=OpenPNM.Phases.models.surface_tension.brock_bird_scaling,
                              sigma_o = 0.0608,
                              To = 363)
