# -*- coding: utf-8 -*-
#
# FCSTpython documentation build configuration file, created by
...
latex_documents = [
  ('index', 'OpenPNM.tex', u'OpenPNM Documentation',
   u'McGill, UofT, AFCC', 'manual'),
]
...
texinfo_documents = [
  ('index', 'OpenPNM', u'OpenPNM Documentation',
   u'EDSL, AFCC', 'OpenPNM', 'Pore Network models for fuel cells.',
   'Miscellaneous'),
]
...
_stdauthor = 'Written by the OpenPNM community'
latex_documents = [
  ('index', 'OpenPNM-ref.tex', 'OpenPNM Reference Guide', _stdauthor, 'manual'),
