...
class VoronoiFibers(Project):
    ...
    points : scalar or array_like
        ...
        If a scalar is given, it is the number of random base points to distribute
        inside the domain. These points will become connected by the Delaunay triangulation.
        A set of points with the size of scalar value*3 will be generated by calling
        ``generate_base_points`` in ``topotools``.
