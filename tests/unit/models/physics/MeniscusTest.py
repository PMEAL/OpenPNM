...
class MeniscusTest:
    ...
    def test_toroidal_touch(self):
        ...
        phys.add_model(
            propname="throat.tor_max",
            model=pm.meniscus.purcell,
            mode="max",
            r_toroid=r_tor,
        )
        phys.add_model(
            propname="throat.tor_touch",
            model=pm.meniscus.purcell,
            mode="touch",
            r_toroid=r_tor,
        )
    ...
    def test_sinusoidal_touch(self):
        ...
        phys.add_model(
            propname="throat.sin_pressure_max", model=pm.meniscus.sinusoidal, mode="max"
        )
        phys.add_model(
            propname="throat.sin_pressure_touch",
    ...
    def test_exceptions(self):
        ...
        phys["throat.scale_b"] = r_tor
        phys.add_model(
            propname="throat.elliptical_pressure",
            model=pm.meniscus.general_toroidal,
            mode="max",
        ...
        phys.add_model(
            propname="throat.exception_pressure",
            model=pm.meniscus.general_toroidal,
            mode="max",
