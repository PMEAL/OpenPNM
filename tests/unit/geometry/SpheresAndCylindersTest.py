...
class SpheresAndCylindersTest:
    ...
    def test_models(self):
        ...
        mod = gmods.throat_length.spheres_and_cylinders
        ...
        mod = gmods.hydraulic_size_factors.spheres_and_cylinders
        assert models["throat.hydraulic_size_factors"]["model"] == mod
        mod = gmods.diffusive_size_factors.spheres_and_cylinders
