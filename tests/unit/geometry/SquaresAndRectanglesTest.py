...
class SquaresAndRectanglesTest:
    ...
    def test_models(self):
        ...
        assert models["pore.volume"]["model"] == gmods.pore_volume.square
        mod = gmods.throat_length.squares_and_rectangles
        ...
        mod = gmods.hydraulic_size_factors.squares_and_rectangles
        assert models["throat.hydraulic_size_factors"]["model"] == mod
        mod = gmods.diffusive_size_factors.squares_and_rectangles
