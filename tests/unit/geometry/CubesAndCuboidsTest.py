...
class SpheresAndCylindersTest:
    ...
    def test_models(self):
        ...
        assert models["pore.volume"]["model"] == gmods.pore_volume.cube
        mod = gmods.throat_length.cubes_and_cuboids
        ...
        mod = gmods.hydraulic_size_factors.cubes_and_cuboids
        assert models["throat.hydraulic_size_factors"]["model"] == mod
        mod = gmods.diffusive_size_factors.cubes_and_cuboids
