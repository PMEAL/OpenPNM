...
class SquaresAndRectanglesTest:
    ...
    def test_models(self):
        ...
        mod = gmods.throat_length.circles_and_rectangles
        ...
        mod = gmods.hydraulic_size_factors.circles_and_rectangles
        assert models["throat.hydraulic_size_factors"]["model"] == mod
        mod = gmods.diffusive_size_factors.circles_and_rectangles
