...
mod3 = op.models.physics.dispersive_conductance.dispersion
phys.add_model(propname='throat.dispersive_conductance',
               model=mod3, regen_mode='normal')

dis = op.algorithms.Dispersion(network=net, phase=phase)
